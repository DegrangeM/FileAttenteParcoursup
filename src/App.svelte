...
<main>
  ...
  refusé <br />
  <Stickman color="green" /> Personne ayant reçu une proposition d'admission et l'ayant
  accepté<br />
  <Stickman color="yellow" /> Personne ayant reçu une proposition d'admission et
  ne l'ayant pas encore accepté ou refusé<br />
